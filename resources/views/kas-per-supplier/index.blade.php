        ...
        <div class="col-md-6">
            <table class="table">
                <tr class="text-center">
                    ...
                    <td>
                        <a href="{{route('kas-per-supplier.print', ['bulan' => $bulan, 'tahun' => $tahun])}}" target="_blank"><img src="{{asset('images/print.svg')}}" alt="dokumen"
...
<div class="container-fluid mt-5">
    <form action="{{route('kas-per-supplier')}}" method="get">
        <div class="row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        ...
                        <a href="{{route('kas-per-supplier.detail-bayar', ['invoice' => $d->invoice_bayar_id])}}">
                            {{$d->uraian}}
                        @else
                        {{$d->uraian}}
                        @endif
