...
<div class="container-fluid">
    ...
    <div class="row justify-content-center mb-3">
        <div class="col-md-4">
            {{-- print pdf button --}}
            <form action="{{route('kas-per-supplier.detail-bayar.print', $invoice->id)}}" method="get" target="_blank">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <form action="{{route('kas-per-supplier')}}" method="get">
                <button type="submit" class="btn btn-primary form-control">Kembali</button>
            </form>
        </div>
    </div>
</div>
