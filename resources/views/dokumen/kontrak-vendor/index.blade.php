...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            <h1><u>KONTRAK PKS</u></h1>
        </div>
    </div>
    @include('swal')
    @include('dokumen.kontrak-vendor.create')
    @include('dokumen.kontrak-vendor.kirim-wa')
                ...
                <tr class="{{ $isDanger ? 'table-danger' : '' }}">
                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex justify-content-center flex-wrap gap-3">
                            ...
                            <form action="{{ route('dokumen.kontrak-vendor.destroy', ['kontrak_vendor' => $d]) }}" method="post" class="d-inline">
                                @csrf
                                @method('delete')
...
<script>
    function kirimWa(data) {
       ...
       document.getElementById('waForm').action = '/dokumen/kontrak-vendor/kirim-wa/'+data.id;
    }
