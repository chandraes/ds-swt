                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 p-9">
                            <form class="form-horizontal" method="POST" action="{{route('akun.update', $user->id)}}">
                                @method('PUT')
                                @csrf
                                <div class=" row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control @error('name')
                                            is-invalid
                                        @enderror" name="name" placeholder="Full Name" value="{{$user->name}}">
                                        @error('name')
                                ...
                                <div class=" row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control @error('username')
                                            is-invalid
                                        @enderror" name="username" placeholder="Username" value="{{$user->username}}">
                                        @error('username')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class=" row mb-4">
                                    ...
                                    @enderror" name="password"
                                            placeholder="Keep empty if not change!">
                                        @error('password')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
